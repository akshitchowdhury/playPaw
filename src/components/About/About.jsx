...
const About = () => {
    return (
        <>
        <div className="bg-yellow-400 text-white font-sans" >
            <div className="container mx-auto p-8">
                <h1 className="text-3xl font-bold mb-4">Welcome to Play Paw!</h1>
            ...
            <div className="bg-fuchsia-700 flex flex-wrap bg" style={{padding: '5%'}}>
