    ...
    return (
        ...
        <div className="about1 bg-yellow-400 text-white font-sans" >
            <div className="container mx-auto p-8">
                ...
                <div className=" flex flex-wrap" style={{ padding: '5%',  border: '3pt solid red' }}>
                     
                        <img src={about} alt="Play Paw Logo" className="rounded-lg border-4 border-fuchsia-700 mb-4" style={{height: '60%', 
