  ...
  return (
    <section >
      ...
      <div className="space-y-8 lg:grid lg:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
        ...
        <h1 className="bubblegum-sans-regular tracking-widest border-fuchsia-900 text-fuchsia-900">Membership Rates</h1>
        <br />
        <br />
        ...
        <div className="space-y-8 lg:grid lg:grid-cols-4 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div className="pricing1 flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  xl:p-8  dark:text-gray-900">
            <h3 className="mb-4 text-2xl font-semibold">Monthly Adventure</h3>
            {/* <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal use & for your next project.</p> */}
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-3xl font-extrabold">Rs. 4000</span>
          ...
          <div className="pricing2 flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  xl:p-8  dark:text-gray-900">
            <h3 className="mb-4 text-2xl font-semibold">Triple Magic</h3>
            {/* <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal use & for your next project.</p> */}
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-3xl font-extrabold">Rs. 7000</span>
              <span className="text-gray-500 dark:text-gray-400">/month</span>
            </div>
            {/* List */}
            <ul role="list" className="mb-8 space-y-4 text-left">
          ...
          <div className="pricing3 flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  xl:p-8 dark:bg-gray-800 dark:text-white">
            ...
            {/* <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal use & for your next project.</p> */}
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-3xl font-extrabold">Rs. 10000</span>
              <span className="text-gray-500 dark:text-gray-400">/month</span>
            </div>
            {/* List */}
            <ul role="list" className="mb-8 space-y-4 text-left">
          ...
          <div className="pricing4 flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  xl:p-8 dark:bg-gray-800 dark:text-white">
            <h3 className="mb-4 text-2xl font-semibold">Annual Blast</h3>
            {/* <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal use & for your next project.</p> */}
            <div className="flex justify-center items-baseline my-8">
    ...
    <h1 className="bubblegum-sans-regular tracking-widest border-fuchsia-900 text-fuchsia-900">We've also got something Special for you</h1>
      <br />
      <br />
      <div className="space-y-8 lg:grid lg:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
          {/* Pricing Card */}
          ...
          <div className="special1 flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  xl:p-8 dark:bg-gray-800 dark:text-white">
            <h3 className="mb-4 text-2xl font-semibold">Party Hall: Groove Time</h3>
            {/* <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Best option for personal use & for your next project.</p> */}
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-3xl font-extrabold">Rs. 12000</span>
              <span className="text-gray-500 dark:text-gray-400">Party Hall only</span>
            </div>
            {/* List */}
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>Weekend charges may vary</span>
              </li>
              <li className="flex items-center space-x-3">
                {/* Icon */}
                <svg
          ...
          <div className="special2 flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100  xl:p-8 dark:bg-gray-800 dark:text-white">
