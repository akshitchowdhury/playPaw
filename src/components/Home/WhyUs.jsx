...
const WhyUs = () => {
  const items = [
    {
      ...
      desc: "Engage your little one in our specially crafted indoor play areas at Play Pawws. Every zone within our indoor play space is designed to ignite boundless imagination and joy.",
    },
    {
      title: "Safety First",
    ...
    },
    {
      ...
      desc: "our interactive games and themed play areas cater to a wide range of ages, from curious toddlers to adventurous tweens aged 2 to 12 years old, ensuring there's excitement for every child.",
    },
    {
      title: "Variety themed events",

      image: i5,
      desc: "At Play Pawws, we host a diverse range of themed events to keep the excitement alive for our young adventurers. From princess parties to superhero extravaganzas, there's always something magical happening at our playground. Join us for a world of endless fun and imagination!",
    },
  ];
  ...
  return (
    <div>
      ...
      >
        What Makes our Playground Unbeatable
      </div>
